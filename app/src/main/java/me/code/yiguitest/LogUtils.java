...
public class LogUtils {
     ...
     * 用于保存日志的文件
     */
    private volatile static File logFile;
    /**
     * 日志中的时间显示格式
     */
    ...
    private static final String MY_TAG = "LogUtils";
    ...
    public static void init(Context context) {
        ...
        String yyyyMMdd = DateTimeUtil.getFormatDateTime(new Date(), "yyyyMMdd");
        createNewLogFile(yyyyMMdd);
    ...
    public static void createNewLogFile(String fileName) {
        ...
        File newLogFile = new File(file.getPath() + "/" + fileName + "_logs.txt");
        ...
        Log.i(MY_TAG, "新的日志文件name: " + newLogFile.getName());
        //缓存维护日志文件名
        logFile = newLogFile;
    }
